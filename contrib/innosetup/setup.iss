...
OutputDir=.\output
OutputBaseFilename=NestEGGSetup
...
[Registry]
Root: "HKCU"; Subkey: "Software\NestEGG\NestEGG-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\NestEGG\NestEGG-Qt,strDataDir|{userappdata}\NestEGG\}');
  Result := True;
end;
